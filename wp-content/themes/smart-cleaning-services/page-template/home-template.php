...
<main id="skip-content">
      ...
      <?php  while ( $query->have_posts() ) : $query->the_post(); ?>
        <div class="slider-box">
          ...
          <div class="slider-inner-box">
            ...
            <div class="slide-btn my-4"><a href="<?php the_permalink(); ?>"><?php esc_html_e('Book Online','smart-cleaning-services'); ?></a></div>
      ...
      <div class="row">
        <?php
          ...
          if($smart_cleaning_featured_cat1){
            $smart_cleaning_page_query4 = new WP_Query(array( 'category_name' => esc_html($smart_cleaning_featured_cat1,'smart-cleaning-services')));
            while( $smart_cleaning_page_query4->have_posts() ) : $smart_cleaning_page_query4->the_post(); ?>
              <div class="col-lg-4 col-md-6">
                <div class="featured-imagebox text-center mb-4">
                  <?php the_post_thumbnail(); ?>
                  <h4 class="mt-2"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
                  <p><?php $excerpt = get_the_excerpt(); echo esc_html( smart_cleaning_string_limit_words( $excerpt, 10 )); ?></p>
                  <div class="servbtn">
                    <a href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','smart-cleaning-services'); ?></a>
                  </div>
                </div>
              </div>
            <?php endwhile;
  ...
  <section id="services-topic" class="py-5">
    <div class="container">
      <?php if(get_theme_mod('smart_cleaning_services_services_category_title') != ''){ ?>
        <h3 class="mb-5 text-center "><?php echo esc_html(get_theme_mod('smart_cleaning_services_services_category_title','')); ?></h3>
      <?php }?>
      <div class="row">
        <?php
          $smart_cleaning_services_catData = get_theme_mod('smart_cleaning_services_menu_items','');
          if($smart_cleaning_services_catData){
            $smart_cleaning_services_page_query = new WP_Query(array( 'category_name' => esc_html($smart_cleaning_services_catData,'smart-cleaning-services')));
            while( $smart_cleaning_services_page_query->have_posts() ) : $smart_cleaning_services_page_query->the_post(); ?>
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="box mb-4">
                  <?php the_post_thumbnail(); ?>
                  <div class="box-cont">
                    <h3 class="mt-2"><?php the_title(); ?></h3>
                    <p><?php $smart_cleaning_services_excerpt = get_the_excerpt(); echo esc_html( smart_cleaning_string_limit_words( $smart_cleaning_services_excerpt, 10 )); ?></p>
                  </div>
