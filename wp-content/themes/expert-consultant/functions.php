...
function expert_consultant_scripts() {
	...
	$custom_css = '
		.logo {
			margin-top: '.esc_attr($expert_consultant_logo_top_margin).'px;
			margin-bottom: '.esc_attr($expert_consultant_logo_bottom_margin).'px;
			margin-left: '.esc_attr($expert_consultant_logo_left_margin).'px;
			margin-right: '.esc_attr($expert_consultant_logo_right_margin).'px;
		}
	';
