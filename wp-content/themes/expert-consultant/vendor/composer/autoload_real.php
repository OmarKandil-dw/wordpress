...
class Expert_Consultant_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function expert_consultant_loadClassLoader($class)
    {
    ...
    public static function expert_consultant_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
