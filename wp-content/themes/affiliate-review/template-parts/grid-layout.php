...
<div class="col-lg-4 col-md-6">
	<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
	    <div class="post-main-box p-3 mb-3 text-center wow zoomIn" data-wow-duration="2s">
	      	<div class="box-image">
	          	<?php 
		            if(has_post_thumbnail() && get_theme_mod( 'affiliate_review_featured_image_hide_show',true) != '') {
		              the_post_thumbnail();
		            }
	          	?>
	        </div>
	        ...
	        <div class="new-text">
	        	<p>
			        <?php $excerpt = get_the_excerpt(); echo esc_html( affiliate_review_string_limit_words( $excerpt, esc_attr(get_theme_mod('affiliate_review_excerpt_number','30')))); ?> <?php echo esc_html( get_theme_mod('affiliate_review_excerpt_suffix','') ); ?>
	        	</p>
	        </div>
