...
--custom-color-1: #deb096;
--custom-color-1-darker: #d59b7a;
--custom-color-1-r: 222;
--custom-color-1-g: 176;
--custom-color-1-b: 150;
--custom-color-1-contrast: white;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-alt-color);
--custom-color-2: rgba(var(--custom-color-2-r),var(--custom-color-2-g),var(--custom-color-2-b),0.92);
--custom-color-2-darker: rgba(134,2,3,0.92);
--custom-color-2-r: 149;
--custom-color-2-g: 2;
--custom-color-2-b: 3;
--custom-color-2-contrast: white;
--custom-color-2-contrast-darker: white;
--custom-color-2-text-color: var(--body-alt-color);
--custom-color-3: rgba(var(--custom-color-3-r),var(--custom-color-3-g),var(--custom-color-3-b),0.54);
--custom-color-3-darker: rgba(98,111,11,0.54);
--custom-color-3-r: 109;
--custom-color-3-g: 123;
--custom-color-3-b: 12;
