...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#skip-content"><?php esc_html_e('Skip to content', 'smart-cleaning'); ?></a>
    <header id="masthead" class="site-header shadow-sm navbar-dark bg-primary">
        <div class="socialmedia">
            ...
            <?php get_template_part('template-parts/topheader/menuheader'); ?>
        </div>
    </header>