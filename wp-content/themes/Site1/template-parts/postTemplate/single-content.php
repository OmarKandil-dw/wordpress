<?php if (function_exists('wc_get_product') && (is_cart() || is_shop() || is_product() || is_checkout())) { the_content(); } else { ?><?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-5f84">
