        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 py-2 align-self-center">
                <?php if(get_theme_mod('smart_cleaning_header_location') != ''){ ?>
                    <p class="mb-0"><i class="fas fa-map-marker-alt"></i> <span><?php esc_html_e('Location','smart-cleaning'); ?></span> : <?php echo esc_html(get_theme_mod('smart_cleaning_header_location','')); ?></p>
                <?php }?>
            </div>
            <div class="col-lg-3 col-md-3 py-2 align-self-center">
                <?php if(get_theme_mod('smart_cleaning_header_phone') != ''){ ?>
                    <p class="mb-0 text-center"><i class="fas fa-phone"></i> <span><?php esc_html_e('Call Us','smart-cleaning'); ?></span> : <?php echo esc_html(get_theme_mod('smart_cleaning_header_phone','')); ?></p>
                <?php }?>
            </div>
            <div class="col-lg-3 col-md-3 py-2 align-self-center">
