...
<main id="maincontent" role="main">
  <?php do_action( 'affiliate_review_before_slider' ); ?>
    ...
    <?php if( get_theme_mod( 'affiliate_review_slider_hide_show', false) != '' || get_theme_mod( 'affiliate_review_resp_slider_hide_show', false) != '') { ?>
      <section id="slider">        
              ...
              <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                ...
                <div class="carousel-caption">
                  <div class="inner_carousel">
                    ...
                    <p class="wow bounceInUp delay-1000" data-wow-duration="2s"><?php $excerpt = get_the_excerpt(); echo esc_html( affiliate_review_string_limit_words( $excerpt, esc_attr(get_theme_mod('affiliate_review_slider_excerpt_number','20')))); ?></p>
